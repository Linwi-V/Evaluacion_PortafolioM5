...
CREATE DATABASE IF NOT EXISTS `requerimiento2`;
USE `requerimiento2`;
...
-- Consulta para obtener todos los pedidos realizados por un cliente específico (id_cliente = 1)
SELECT p.id_pedido, p.producto, p.cantidad, p.fecha
FROM Pedidos p
